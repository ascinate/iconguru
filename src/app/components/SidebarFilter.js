...
export default function SidebarFilter() {
    ...
    const Categories = [
      ...
      { id: 12, title: 'Device' , value: 'Names', img: '/email.svg'  },
      { id: 13, title: 'Finance' , value: 'Names', img: '/email.svg'  },
      { id: 14, title: 'Health & Medical' , value: 'Names', img: '/email.svg'  },
      { id: 15, title: 'Documents' , value: 'Names', img: '/email.svg'  },
      { id: 16, title: 'Health & Medical' , value: 'Names', img: '/email.svg'  },
    ];

    return (
      <>
        <aside className="sidebarsd_div d-inline-block w-100  pt-4">
            ...
            <div className="sub_headings01 d-inline-block w-100">
                ...
                <div className="options_names d-flex flex-wrap align-items-center mt-3">
                    <div className="cmout form-check position-relative ps-0">
                        <input
                            type="radio"
                            value="option1"
                            id="option1"
                ...
                <div className="options_names d-flex flex-wrap align-items-center mt-3">
                    ...
                    {Categories.slice(0, visibleItems).map((post, index) => (
                          <div className="cmout form-check position-relative ps-0" key={index}>
                              <input
                                  type="radio"
                                  value={post.value}
                                  id={post.id}
                    ...
                    {visibleItems < Categories.length && (
                      <button className="btn btn-load-more" onClick={loadMoreItems}>Load More</button>
                    )}
                </div>
