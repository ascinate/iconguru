                ...
                <div className="row align-items-start">
                  ...
                  <div className="col-lg-6">
                    <div className="row gy-4 g-lg-4">
                      {plans.map((plan) => (
                        <div key={plan.subscription_id} className="col-lg-6">
                          <div className="card months-div">
                            <h2>{plan.name}</h2>
                            <h3 className="mt-3"> <strong> ${plan.price} </strong>  <small> / {plan.duration} </small> </h3>
                            <p>Per month, billed <br/> each year <strong> {plan.icon_limit ? plan.icon_limit : "Unlimited"} </strong> </p>
